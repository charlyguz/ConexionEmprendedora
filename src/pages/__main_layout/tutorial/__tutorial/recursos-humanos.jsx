...
export default function Tutoriales() {
  ...
  const [activeSection, setActiveSection] = useState(3) // Estado para rastrear la sección activa
      ...
      <div className="w-full bg-primary h-2/3 mt-16">
        <div className="lg:px-20 w-full max-sm:10px">
          <div className="w-full pt-4 pb-7 bg-white rounded-md px-8">
            <TutorialesSection
              title={TutorialPreview.Title4}
              texto={TutorialPreview.Texto4}
              posts={TutorialPreview.Seccion4Posts}
