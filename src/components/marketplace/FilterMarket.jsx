    ...
    <>
          ...
          >
            <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-6 flex flex-col overflow-y-auto">
              <div className="px-4 flex items-center justify-between">
                ...
                >
                  <span className="sr-only">Cerrar opciones</span>
      ...
      <div className="max-w-3xl mx-auto px-4 text-center sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="md:py-18 py-8">
          <h1 className="text-4xl sm:font-extrabold tracking-tight text-gray-900 font-bold">
            {info.name}
          </h1>
          <p className="mt-4 max-w-3xl mx-auto text-base text-gray-500 max-sm:text-xs">
            {info.message}
          </p>
        </div>
