...
export default function ExtrasMarketplace() {
  return (
    <div className="bg-white">
      <FilterMarket
        info={{
          name: 'Lo más vendido',
          message:
            'Descubre los favoritos de las personas: ¡Lo más vendido te espera con los productos que están causando sensación!',
        }}
      />
