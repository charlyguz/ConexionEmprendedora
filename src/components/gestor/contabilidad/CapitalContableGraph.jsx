...
export default function CapitalContableGraph() {
    ...
    if (content === 'initial') {
      ...
      return (
        <div>
          ...
          <a href="https://www.enko.org/mx/encoppel/seccion/balance-general-uso-e-interpretacion-329/284">
            <img src="/assets/gestor-recursos/capital1.png" alt="" />
          </a>
        </div>
      )
    }
  ...
  const options = {
    ...
    labels: ['Capital social', 'Reservas'],
    dataLabels: {
      enabled: false,
    },
    legend: {
