...
export default function PasivosGraph() {
      ...
      return (
        <div>
          ...
          <video className="w-full" height="250" controls>
            <source
              src="https://static.enko.org/videos/enko_08-08-22/p4_+video(1).mp4"
              type="video/mp4"
            />
  ...
  const options = {
    series: [6.3, 14.2, 4.7, 2.4, 5.4],
    colors: ['#1C64F2', '#FC54F8', '#16BDCA', '#FDBA8C', '#E74694'],
    chart: {
      height: 320,
      width: '100%',
      type: 'donut',
  ...
  return (
    <div className="h-full w-full bg-white rounded-lg shadow-lg dark:bg-gray-800 p-4 md:p-6 grid">
      <div className="flex justify-between pb-4  ">
        ...
        <div className="relative">
          <button
            onClick={toggleMenuDownload} // Cambiamos el evento para que el menú se toggle con el clic
            type="button"
