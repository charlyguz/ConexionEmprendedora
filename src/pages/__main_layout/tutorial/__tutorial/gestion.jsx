...
export default function Tutoriales() {
  ...
  if (cursoSeleccionado) {
    return (
      <div className="relative w-full bg-primary pt-16 pb-20  sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="w-full bg-primary h-2/3 mt-16">
        <div className="lg:px-20 w-full max-sm:10px">
          ...
          <div className="w-full pt-4 pb-7 bg-white rounded-md px-8">
            <TutorialesSection
              title={TutorialPreview.Title1}
              texto={TutorialPreview.Texto1}
              posts={TutorialPreview.Seccion1Posts}
